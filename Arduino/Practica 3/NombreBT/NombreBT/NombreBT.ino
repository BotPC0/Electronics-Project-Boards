...
/* Programa el módulo bluetooth HC-06 con un nuevo: NOMBRE (Nombre de 20 caracteres)
  PIN (Clave de cuatro números)
  BPS (Velocidad de conexión en baudios)
  CONEXIONES: ARDUINO BLUETOOTH 5V VCC
  GND GND
  PIN 2 TX
  PIN 3 RX
*/
SoftwareSerial blue(2, 3);
//Crea conexión al bluetooth - PIN 2 a TX y PIN 3 a RX
char NOMBRE[21] = "BTAndrei"; // Nombre de 20 caracteres máximo
